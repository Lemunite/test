...
import { sampleWithRequiredData } from '../additional-information.test-samples';
...
describe('AdditionalInformation Management Component', () => {
  let comp: AdditionalInformationComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(AdditionalInformationComponent, '')
      .compileComponents();
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.additionalInformations()[0]).toEqual(expect.objectContaining({ id: 11732 }));
  });

  describe('trackId', () => {
    it('should forward to additionalInformationService', () => {
      const entity = { id: 11732 };
      jest.spyOn(service, 'getAdditionalInformationIdentifier');
      const id = comp.trackId(entity);
      expect(service.getAdditionalInformationIdentifier).toHaveBeenCalledWith(entity);
