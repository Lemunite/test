...
import { EntityArrayResponseType, VaccineService } from '../service/vaccine.service';
import { VaccineDeleteDialogComponent } from '../delete/vaccine-delete-dialog.component';
...
export class VaccineComponent implements OnInit {
  ...
  trackId = (item: IVaccine): number => this.vaccineService.getVaccineIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.vaccines.set(dataFromBody);
  }

  protected fillComponentAttributesFromResponseBody(data: IVaccine[] | null): IVaccine[] {
    return data ?? [];
  }
  ...
  protected queryBackend(): Observable<EntityArrayResponseType> {
    ...
    return this.vaccineService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
