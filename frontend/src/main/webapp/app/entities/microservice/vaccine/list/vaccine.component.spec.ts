...
import { sampleWithRequiredData } from '../vaccine.test-samples';
...
describe('Vaccine Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.vaccines()[0]).toEqual(expect.objectContaining({ id: 27715 }));
  });

  describe('trackId', () => {
    it('should forward to vaccineService', () => {
      const entity = { id: 27715 };
      jest.spyOn(service, 'getVaccineIdentifier');
      const id = comp.trackId(entity);
      expect(service.getVaccineIdentifier).toHaveBeenCalledWith(entity);
