...
import { AllergyService, EntityArrayResponseType } from '../service/allergy.service';
...
export class AllergyComponent implements OnInit {
  ...
  protected readonly allergyService = inject(AllergyService);
  protected readonly activatedRoute = inject(ActivatedRoute);
  protected readonly sortService = inject(SortService);
  protected modalService = inject(NgbModal);
  protected ngZone = inject(NgZone);

  trackId = (item: IAllergy): number => this.allergyService.getAllergyIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.allergies.set(dataFromBody);
  }
