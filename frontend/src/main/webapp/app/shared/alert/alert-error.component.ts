...
export class AlertErrorComponent implements OnDestroy {
  ...
  private handleDefaultError(httpErrorResponse: HttpErrorResponse): void {
    if (httpErrorResponse.error && typeof httpErrorResponse.error === 'object' && httpErrorResponse.error.message) {
      this.addErrorAlert(
        httpErrorResponse.error.detail ?? httpErrorResponse.error.message,
        httpErrorResponse.error.message,
        httpErrorResponse.error.params,
      ...
      // Fallback for null/undefined error responses
      this.addErrorAlert(`HTTP ${httpErrorResponse.status}: ${httpErrorResponse.statusText}`, 'error.http.response', {
