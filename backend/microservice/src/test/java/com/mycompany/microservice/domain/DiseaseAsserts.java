...
public class DiseaseAsserts {
    ...
    public static void assertDiseaseUpdatableFieldsEquals(Disease expected, Disease actual) {
        assertThat(actual)
            ...
            .satisfies(a -> assertThat(a.getSpecificType()).as("check specificType").isEqualTo(expected.getSpecificType()))
    ...
    public static void assertDiseaseUpdatableRelationshipsEquals(Disease expected, Disease actual) {
        assertThat(actual)
            ...
            .satisfies(a -> assertThat(a.getFamilyDisease()).as("check familyDisease").isEqualTo(expected.getFamilyDisease()));
    }
}
