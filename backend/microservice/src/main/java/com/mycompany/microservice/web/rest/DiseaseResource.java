...
import com.mycompany.microservice.service.DiseaseService;
...
/**
 * REST controller for managing {@link com.mycompany.microservice.domain.Disease}.
 */
@RestController
...
public class DiseaseResource {
    ...
    private static final String ENTITY_NAME = "microserviceDisease";
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<DiseaseDTO>> getAllDiseases(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
